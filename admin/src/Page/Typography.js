                ...
                <div className="row g-4">
                    ...
                    <div className="col-sm-12 col-xl-6">
                        ...
                        <div className="bg-secondary rounded h-100 p-4">
                            ...
                            <div className="p-2 mb-2 bg-primary text-white" style={{borderRadius:'6px'}}>.bg-primary</div>

                            <div className="p-2 mb-2 bg-secondary text-white"style={{borderRadius:'6px'}}>.bg-secondary</div>

                            <div className="p-2 mb-2 bg-success text-white"style={{borderRadius:'6px'}}>.bg-success</div>

                            <div className="p-2 mb-2 bg-danger text-white"style={{borderRadius:'6px'}}>.bg-danger</div>

                            <div className="p-2 mb-2 bg-warning text-dark"style={{borderRadius:'6px'}}>.bg-warning</div>

                            <div className="p-2 mb-2 bg-info text-dark"style={{borderRadius:'6px'}}>.bg-info</div>

                            <div className="p-2 mb-2 bg-light text-dark"style={{borderRadius:'6px'}}>.bg-light</div>

                            <div className="p-2 mb-2 bg-dark text-white"style={{borderRadius:'6px'}}>.bg-dark</div>

                            <div className="p-2 mb-2 bg-body text-dark"style={{borderRadius:'6px'}}>.bg-body</div>

                            <div className="p-2 mb-2 bg-white text-dark"style={{borderRadius:'6px'}}>.bg-white</div>

                            <div className="p-2 mb-0 bg-transparent text-dark"style={{borderRadius:'6px'} }>.bg-transparent</div>
